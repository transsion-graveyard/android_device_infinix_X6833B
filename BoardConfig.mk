...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := kasim
...
BOARD_PREBUILT_VENDORIMAGE := $(DEVICE_PATH)/prebuilt/vendor/vendor.img
...
# OTA assert
TARGET_OTA_ASSERT_DEVICE := X6833B,Infinix-X6833B,kasim
...
BOARD_AVB_VBMETA_VENDOR_KEY_PATH := device/infinix/X6833B/prebuilt/vendor/infinity_testkey.pem
...
BOARD_AVB_VENDOR_ADD_HASHTREE_FOOTER_ARGS += --hash_algorithm sha256 --do_not_generate_fec
